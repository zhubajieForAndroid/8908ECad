 ...
 * 自定义模式,常规
 */
public class ConventionalMaintenanceActivity extends BaseActivity implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    private void analysisData(byte[] buffer) {
        ...
        if (mIsStar) {
            Log.d(TAG, "analysisData: 自动点击了按钮了");
    ...
    private void initData() {
        ...
        mAdapter.setOnGasClickListener(new MaintainAdapter.OnGasClickListener() {
            ...
            public void onGasClick() {
                GasDialog mGasDialog = new GasDialog(ConventionalMaintenanceActivity.this, R.style.dialog);
