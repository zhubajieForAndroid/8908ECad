 ...
 * 常规模式
 */
public class ConventionalMaintenanceActivityDemo extends BaseActivity implements View.OnClickListener {
   ...
   /* @Bind(R.id.surplus)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bleDeviceMac = intent.getStringExtra("BleDeviceMac");
        //启动连接蓝牙的服务
        Intent bleIntent = new Intent(this, SendBleDataService.class);
        bleIntent.putExtra("BleDeviceMac", bleDeviceMac);
   ...
   /*--------------------定时检查排空任务开始---------------------*/
    ...
    private void analysisData(byte[] buffer) {
       ...
       // String adNumbwe = DataUtil.getADNumbwe(buffer);                     //电子秤AD值
        ...
        //深度模式第一阶段臭氧和雾化共同运行时间 2019年3月12日17:32:44修改单独设置臭氧,雾化,净化时间
    ...
    private void initData() {
        ...
        String[] titles = {"检测气体","设备运行"};
        mAdapter = new MaintainAdapter(this,arr,mEquipmentBuffer,mIsRoutine,titles);
        mViewPager.setAdapter(mAdapter);
        mTabLayout.setupWithViewPager(mViewPager);
        mAdapter.setOnGasClickListener(new MaintainAdapter.OnGasClickListener() {
            @Override
            public void onGasClick() {
                GasDialog mGasDialog = new GasDialog(ConventionalMaintenanceActivityDemo.this,R.style.dialog);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if ((mDownY - mUpY) > 50) {        //手指向上滑动
                            ...
                            if (mVideoDialog != null && mVideoDialog.isShowing()) {
                                ...
                                mVideoDialog = new Dialog(ConventionalMaintenanceActivityDemo.this, R.style.dialog);
