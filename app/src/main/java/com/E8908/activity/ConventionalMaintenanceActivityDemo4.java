...
public class ConventionalMaintenanceActivityDemo4 extends BaseActivity implements View.OnClickListener, DialogInterface.OnDismissListener, BackErrorDialog.OnBackClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conventional_maintenance4);
        ...
        //是否记录次数
        mIsSaveCount = intent.getBooleanExtra("isSaveCount", true);
    ...
    private void startOneTask(final int time) {
        if (mHomeVideoPagerAdapter != null) {
            ...
            mHomeVideoPagerAdapter.startPlay();
        }
    ...
    private void initVideoView() {
        ...
        mHomeVideoPagerAdapter = new RunVideoPagerAdapter(getSupportFragmentManager(), videoCount);
        mHomeViewpager.setAdapter(mHomeVideoPagerAdapter);
