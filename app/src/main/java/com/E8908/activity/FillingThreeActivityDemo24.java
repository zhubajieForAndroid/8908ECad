...
/**
 * 2019年4月24日17:42:26修改搅拌逻辑,点击"开始搅拌""按钮,先开启加,注加20秒，加注过程中第10秒判断一次电子秤的数值变化，然后回收40秒，第10秒判断一次电子秤的数值变化,如果变化的数值没有大于50ML就报错。整个搅拌过程不管多少分钟，加注判断一次，回收判断一次就行了
 */
public class FillingThreeActivityDemo24 extends BaseActivity implements View.OnTouchListener, View.OnClickListener {
    ...
    private int juChangeState;              //判断电子秤变化的次数,总共判断3次加注2次回收1次
