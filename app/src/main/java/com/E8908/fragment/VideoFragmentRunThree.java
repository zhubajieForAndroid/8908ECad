...
public class VideoFragmentRunThree extends Fragment implements View.OnClickListener, View.OnTouchListener, VideoDialog.OnCurrentPosition {
    ...
    private void init(View inflate) {
        ...
        mUriThree = "android.resource://" + mContext.getPackageName() + "/" + R.raw.info_three;
        ...
        mVideoView.setBackground(mContext.getResources().getDrawable(R.mipmap.video_img_one));
        //准备视频完成监听
        ...
        mVideoDialog = new VideoDialog(mContext, R.style.dialog, mUriThree);
