...
public class VideoFragmentThree extends Fragment implements View.OnClickListener, View.OnTouchListener, VideoDialog.OnCurrentPosition {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.view_video_three, container, false);
        mContext = getContext();
        init(inflate);
        return inflate;
    }
    ...
    private void init(View inflate) {
        ...
        mUriOne = "android.resource://" + mContext.getPackageName() + "/" + R.raw.info_three;
