...
public class MaintainView extends RelativeLayout {
    ...
    public MaintainView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    private void init(Context context) {
        View.inflate(context, R.layout.view_maintain, this);
    ...
    public void setData(byte[] buffer, Context context) {
