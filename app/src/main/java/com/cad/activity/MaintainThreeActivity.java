...
public class MaintainThreeActivity extends BaseActivity implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if ((x >= 25 && x <= 287) && (y >= 710 && y <= 780)) {                //返回
            ...
            Intent intent = new Intent(this, ConventionalMaintenanceActivity.class);
