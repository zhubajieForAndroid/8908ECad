...
import com.cad.widget.LoginDialog;
import com.cad.widget.OnlineDialog;
import com.cad.widget.SetDateDialog;
import com.cad.widget.SetIDDialog;
import com.cad.widget.SetVersionDialog;
...
public class SystemSettingsActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        } else if ((x >= 31 && x <= 1244) && (y >= 73 && y <= 135)) {         //设备上线
            if (isPower) {
                SendUtil.controlVoice();
        ...
        } else if ((x >= 34 && x <= 1237) && (y >= 147 && y <= 201)) {         //WiFi
            SendUtil.controlVoice();
            Intent i = new Intent(this, WifiActivity.class);
            startActivity(i);
        } else if ((x >= 35 && x <= 1234) && (y >= 215 && y <= 275)) {         //硬件版本
            if (isPower) {
                SendUtil.controlVoice();
        ...
        } else if ((x >= 35 && x <= 1234) && (y >= 352 && y <= 416)) {         //主控版本
            if (isPower) {
                SendUtil.controlVoice();
        ...
        } else if ((x >= 35 && x <= 1234) && (y >= 427 && y <= 489)) {         //日期
            if (isPower) {
                SendUtil.controlVoice();
        ...
        } else if ((x >= 33 && x <= 1234) && (y >= 280 && y <= 345)) {         //回复出厂设置
            if (isPower) {
        ...
        } else if ((x >= 35 && x <= 1236) && (y >= 498 && y <= 548)) {                             //设置ID号
            if (isPower) {
                if ("00000000".equals(mEquipmentNumber)) {
