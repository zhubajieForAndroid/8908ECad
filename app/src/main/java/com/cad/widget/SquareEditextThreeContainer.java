...
public class SquareEditextThreeContainer extends RelativeLayout {
    ...
    public SquareEditextThreeContainer(Context context) {
        super(context);
    }

    public SquareEditextThreeContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        View.inflate(context, R.layout.view_editext_custom_date, this);
